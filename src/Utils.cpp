 ...
 */
std::string Utils::aesGcmEncrypt(const std::string &data, const std::string &key, const std::string &iv) {
 ...
 */
std::string Utils::aesGcmDecrypt(const std::string &data, const std::string &key, const std::string &iv) {
    EVP_CIPHER_CTX *ctx = EVP_CIPHER_CTX_new();
    if (!ctx) handleOpenSSLErrors();
